...
std::unordered_map<std::string, unsigned short> noteMapping{
  { "SILENCE", 0 }, { "B0", 31 },    { "C1", 33 },    { "CS1", 35 },  { "D1", 37 },
  { "DS1", 39 },    { "D1", 37 },    { "DS1", 39 },   { "E1", 41 },   { "F1", 44 },
  { "FS1", 46 },    { "G1", 49 },    { "GS1", 52 },   { "A1", 55 },   { "AS1", 58 },
  { "B1", 62 },     { "C2", 65 },    { "CS2", 69 },   { "D2", 73 },   { "DS2", 78 },
  ...
  { "AS4", 466 },   { "B4", 494 },   { "C5", 523 },   { "CS5", 554 }, { "D5", 587 },
  { "DS5", 622 },   { "E5", 659 },   { "F5", 698 },   { "FS5", 740 }, { "G5", 784 },
  { "GS5", 831 },   { "A5", 880 },   { "AS5", 932 },  { "B5", 988 },  { "C6", 1047 },
  ...
  { "A7", 3520 },   { "AS7", 3729 }, { "B7", 3951 },  { "C8", 4186 }, { "CS8", 4435 },
  { "D8", 4699 },   { "DS8", 4978 }
};

const uint16_t sourceNotes[] = { 0,  3, 4, 5, 6, 7, 5, 5, 6, 6, 7, 78, 8, 7, 6, 5, 45,
                                 54, 4, 4, 4, 4, 4, 4, 3, 3, 3, 2, 2,  2, 2, 1, 2 };